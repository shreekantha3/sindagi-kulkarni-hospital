# Kulkarni Hospital — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-kulkarni-hospital/
- **Repo:** `shreekantha3/sindagi-kulkarni-hospital` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-kulkarni-hospital/'` for GitHub Pages project-site hosting.
